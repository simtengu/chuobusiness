...
<!-- products section................................................... -->
  <div class="p-2 my-1">
    <a href="{{ route('chuoproduct.create') }}" class="btn btn-outline-primary">+New chuobusiness shop item</a>
  </div>
          ...
          <div id="product-div" >
            <table id="products_table">
             <tr>
               ...
               <td id="right" rowspan="2">@if(count($product->image))<img src="{{ asset('pictures') }}/{{ $product->image[0]->name }}">@endif</td>
             </tr>
             <tr>
