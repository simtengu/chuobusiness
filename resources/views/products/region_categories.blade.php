...
<!-- Sidebar end=============================================== -->
		<div class="span9">	
	<a style="padding: 8px 8px 8px 0px; font-size: 19px; font-weight: bold; " class="text-orange text-arial" href="{{ url('/region_products') }}/{{ $region_id }}/1">{{ $region->name }} Region</a>
	<div class="region-categories-div">
		...
		<div id="products_filtering" style="padding: 2px 5px;" class="row">
	      <a href="{{ url('/region_categories') }}/{{ $region_id }}/{{ $category_id }}/1" class="btn btn-outline-secondary">Latest @if($order_type == 1) <span class="badge">{{ count($products) }}</span> @endif</a>
	      <a href="{{ url('/region_categories') }}/{{ $region_id }}/{{ $category_id }}/2" class="btn btn-outline-secondary">cheap first
           @if($order_type == 2) <span class="badge">{{ count($products) }}</span> @endif
	      </a>	
	      <a href="{{ url('/region_categories') }}/{{ $region_id }}/{{ $category_id }}/3" class="btn btn-outline-secondary">expensive first
	      	@if($order_type == 3) <span class="badge">{{ count($products) }}</span> @endif
	      </a>
	      <a href="{{ url('/region_categories') }}/{{ $region_id }}/{{ $category_id }}/4" class="btn btn-outline-secondary">used only
          @if($order_type == 4) <span class="badge">{{ count($products) }}</span> @endif
	      </a>	
	      <a href="{{ url('/region_categories') }}/{{ $region_id }}/{{ $category_id }}/5" class="btn btn-outline-secondary">new only
