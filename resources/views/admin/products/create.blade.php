...
<div id="new_product" class="mb-2 py-3">
    ...
    <form id="product_save" method="POST" action="{{ route('adminProduct.store') }}" enctype="multipart/form-data">
      @csrf
      ...
      <div   class="row">
        ...
        <div id="brandDiv" class="form-group col-sm-6">
          <label for="brand_name" class="text-18 text-arial">Brand(if any)</label>
           <select selected id="brand_name" name="brand_id" class="form-control">
        ...
        <div class="form-group col-sm-6">
            <label for="user_id" class="text-18 text-arial">Owner</label>
